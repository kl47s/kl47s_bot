...
Original file is located at
    https://colab.research.google.com/drive/1hN0FKKmnFCEWywyZXFayrHpawBlenNsa
"""
...
bot = telebot.TeleBot('5792781578:AAFOy3Kd8f5OQSPQnzIFkF9wGtnNncKtxUA')
...
def update():
	with open('/content/drive/MyDrive/Colab Notebooks/questions_2.txt', encoding='utf-8') as f:
		content = f.read()
...
def get_text_messages(message):
	...
	if command =="не правильно":
		bot.send_message(message.from_user.id, "повторите")
